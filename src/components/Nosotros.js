    ...
    render() {
        return <div className="nosotros">
            ...
            <div className="body-nosotros">
                ...
                <Card style={{width: '350px', height: '350px', border: 'none', borderRadius: '0px', margin: '40px', minHeight: '200px', position: 'inherit'
                }} className="CardNosotros">
                ...
                <br/>
                <Card style={{width: '350px', height: '350px', border: 'none', borderRadius: '0px', margin: '40px'}}
                      className="CardNosotros">
                    <Card.Body style={{padding: '30px'}}>
                        <Card.Title className="CardNosTitle" style={{
                            fontfamily: 'Gilroy-Heavy',
